...
public class arthorianadmin extends JavaPlugin implements CommandExecutor {
	public boolean onCommand(CommandSender sender, Command cmd, String arg2, String[] arg3) {
		if (cmd.getName().equalsIgnoreCase("arthorianadmin") || cmd.getName().equalsIgnoreCase("admin") || cmd.getName().equalsIgnoreCase("aadmin") || cmd.getName().equalsIgnoreCase("aa") || cmd.getName().equalsIgnoreCase("a")) {
			if(arg3[0]==null) {
			language.aa(sender);
			...
			return true; }
				...
				if(sender.hasPermission("arthorian.admin") && sender.hasPermission("arthorian.netman")) {
					if (arg3.length == 2) {
						...
						staffmanager.makeStaff(sender, arg3[1], arg3[2]); // Makes them staff
						return true;
					}
				}
			}
